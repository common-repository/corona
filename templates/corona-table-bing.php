...
if (!$data) {
    echo 'This feature is stoped, we are fixing';
    return;
}
?>
    ...
    <table id="<?php echo esc_attr($id); ?>" data-page-length="<?php echo esc_attr($params['showing']); ?>">
        ...
        <?php foreach ($data as $key => $value) : ?>
            <tr>
                ...
                <td><?php echo number_format($value->totalConfirmed); ?></td>
                <?php if ($detail) : ?>
                    <td><?php echo number_format($value->todayCases); ?></td>
                <?php endif; ?>
                <td><?php echo number_format($value->totalDeaths); ?></td>
                <?php if ($detail) : ?>
                    <td><?php echo number_format($value->todayDeaths); ?></td>
                <?php endif; ?>
                <td><?php echo number_format($value->totalRecovered); ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
